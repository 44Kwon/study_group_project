...
public class StudyMemberService {
    ...
    public StudyMember validateLeaderWithUserIdAndStudyGroupId(Long userId, Long studyGroupId) {
        ...
        StudyMember studymember = studyMemberRepository.findByUserIdAndStudyGroupIdAndStatus(userId, studyGroupId, StudyMember.ActiveStatus.ACTIVE)
    ...
    public StudyMember validateMemberWithUserId(Long userId, Long groupId, StudyMember.ActiveStatus status) {
        return studyMemberRepository.findByUserIdAndStudyGroupIdAndStatus(userId, groupId, status)
                .orElseThrow(() -> new BusinessLogicException(ExceptionCode.MEMBER_NOT_FOUND));
    }
